...
<body>
            <h1 class="a" align = "center">Football</h1>&nbsp;

 

<?php

    $sql = "SELECT redscore, bluescore FROM score_data WHERE gameEnd = '1' AND sport = 'football' ";
...
<?php
    ...
    $query = "SELECT * FROM score_data WHERE sport = 'football' LIMIT 10";
